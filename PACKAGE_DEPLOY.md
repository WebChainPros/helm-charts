...
* **일상 배포**: `manifests/ui-proxy.yaml`이 원격 컨테이너 저장소(`ghcr.io/webchainpro-cpu/firefly-custom-ui:v10`)를 참조하므로, **UI 소스코드 빌드 없이 즉시 배포**됩니다.
...
docker build -t ghcr.io/webchainpro-cpu/firefly-custom-ui:v10 -f - . << 'EOF'
...
EOF
docker push ghcr.io/webchainpro-cpu/firefly-custom-ui:v10
